...
from utils.constants.myconstant import MY_CONSTANT

class ExampleTool(Tool):
    """An Example of a modularized tool"""
    ...
    def __init__(self) -> None:
        ...
        @self.params: tool parameters (set with archelp.get_params())
        """
    ...
    def execute(self, parameters:list[arcpy.Parameter], messages:list) -> None:
        ...
        archelp.msg(f"MY_CONSTANT: {MY_CONSTANT}")
        return